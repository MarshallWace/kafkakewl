...
/**
 * The local topic alias id in the current topology's namespace (fully qualified isn't really needed anyway because aliases aren't currently exposed to other topologies).
 */
...
/**
 * The local application alias id in the current topology's namespace (fully qualified isn't really needed anyway because aliases aren't currently exposed to other topologies).
 */
